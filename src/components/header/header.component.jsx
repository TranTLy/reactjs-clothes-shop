...
import { HeaderContainer, LogoLink, OptionContainer, OptionLink, OptionDiv } from './header.style';
...
const Header = ({ user, hidden }) => (
    <HeaderContainer >
        ...
        <OptionContainer>
            ...
            {
                user ? <OptionLink as='div' className="option" onClick={() => auth.signOut()}>Sign Out</OptionLink> :
